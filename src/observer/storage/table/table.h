...
public:
 ...
 /**
  ...
  RC delete_record(const Record &record,bool handle_index=true);
  RC update_record(Record &record,const char* attr_name,Value* value); //new
  ...
  // TODO refactor
  RC create_index(Trx *trx, std::vector<const FieldMeta *>field_meta, const char *index_name,IndexType tp);
...
private:
  ...
  RC check_unique_indexes(const char *record);
private:
